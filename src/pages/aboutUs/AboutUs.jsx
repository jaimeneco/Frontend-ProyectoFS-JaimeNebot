        ...
        <>
            ...
            <main className='Main-about'>
                <div className='Main-aboutContent'>
                    ...
                    <img className='img' src="/imgs/img-aboutUs/img-aboutPrincipal.jpg" alt="Imagen ONPIK" />
                </div>
                <div className='Content-historia'>
                    <img className='Content-img' src="/imgs/img-aboutUs/img-aboutFir.jpg" alt="Imagen historia" />
                ...
                <div className='Content-valores'>
                    <img className='Content-img' src="/imgs/img-aboutUs/img-aboutSec.png" alt="Imagen valores" />
                    <div className='Content-info'>
                ...
                <div className='Logos'>
                    ...
                    <img className='Logos-img' src="/imgs/img-aboutUs/img-logos.png" alt="Empresas colaboradoras" />
                </div>
            </main >
